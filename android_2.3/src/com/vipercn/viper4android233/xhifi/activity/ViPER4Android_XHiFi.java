...
public final class ViPER4Android_XHiFi extends PreferenceActivity
{
    ...
    {
    	SharedPreferences preferences = getSharedPreferences(ViPER4Android_XHiFi.SHARED_PREFERENCES_BASENAME + ".settings", 0);
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item)
	{
        ...
        case R.id.notify:
        {
        	...
        	if (bEnableNotify)
        	{
        		...
        		sendBroadcast(new Intent(ViPER4Android_XHiFi.ACTION_SHOW_NOTIFY));
        	}
        	else
        	{
        		Log.i("ViPER4Android_XHiFi", "show_notify = false");
        		sendBroadcast(new Intent(ViPER4Android_XHiFi.ACTION_CANCEL_NOTIFY));
        	}
        	return true;
        }
